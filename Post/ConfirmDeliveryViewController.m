...
//  Post
//
//  Created by wangsl-iMac on 15/3/9.
//  Copyright (c) 2015年 cheng. All rights reserved.
//

#import "ConfirmDeliveryViewController.h"
#import "GoodsPhotoViewController.h"
@interface ConfirmDeliveryViewController () <photoGroupDelegate>
...
- (void)viewDidLoad {
    ...
    self.photoGroupTableViewCell.delegate = self;
...
//    structPhotoInfo * info = [item objectForKey:key];
        ...
        infoView.photoImage = [UIImage imageNamed:@"2.JPG"];//info.image;
